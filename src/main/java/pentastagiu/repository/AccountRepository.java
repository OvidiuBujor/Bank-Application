...
//     */
//    static long calculateNrAccFromFile(){
...
//     * @throws CustomException when the user's credentials are not valid
//     */
//    public static User validateUser(String[] userCredentials) throws CustomException {
//        Session session = FACTORY.getCurrentSession();
//        try (session) {
...
//        } catch (NoResultException e) {
//            throw new CustomException("User credentials are not correct.");
//        }
//    }
