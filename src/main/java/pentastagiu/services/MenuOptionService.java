...
//        try {
//            User user = userRepository.findByUsernameAndPassword(userService.getUserCredentials()[0],userService.getUserCredentials()[1]);
//            if (user == null)
//                throw new CustomException("Wrong username/password.");
//            else
//                userService.setCurrentUser(user);
//
//            //userService.setCurrentUser(AccountRepository.validateUser(userService.getUserCredentials()));
//            result = true;
